...
play-fps-name = fps
play-fps-description = Number of frames to display per second. Range from { $play-fps-description-min } to { $play-fps-description-max } (inclusive). Default value is { $play-fps-description-default }
